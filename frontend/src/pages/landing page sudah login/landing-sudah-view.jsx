    ...
    <div className="min-h-screen bg-[#c9a7ff] text-gray-900">
      ...
      <section className="bg-[#e8e7f3] min-h-screen flex items-center justify-center px-6 relative">
        ...
        <img
          src="/wave3.png"
          alt="Background Wave"
          className="absolute inset-0 w-full h-full object-cover z-0 rotate-"
        />
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-right relative z-10 pl-4 -right-25">
      ...
      <section className="bg-[#e8e7f3] min-h-screen flex items-center justify-center px-6 relative">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-left relative z-10 pr-4">
            <p className="uppercase text-purple-600 font-semibold tracking-widest mb-2">
              Eksplorasi Diri
            </p>
            <h2 className="text-4xl font-bold mb-4 text-gray-900">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 bg-white rounded-3xl shadow-xl max-w-6xl w-full overflow-hidden">
          <div className="p-10 text-gray-800 space-y-6">
            ...
            <p>
              ...
              emosionalnya. Kami hadir sebagai solusi atas kesulitan banyak
              orang dalam memahami perubahan mood dan stres yang sering
              terabaikan.
            </p>
            <p>
              ...
              digital untuk eksplorasi diri dan peningkatan kesejahteraan
              mental.
            </p>
            <blockquote className="border-l-4 pl-4 italic text-gray-700 border-gray-300">
              ...
              Inovasi Kesehatan, dengan pendekatan design thinking dan semangat
      ...
      <section
        ...
        <div
          ...
          <p style={{ marginBottom: "0.8rem", fontStyle: "italic" }}>
            ...
            sesuai banget sama kondisi emosiku, kayak lagi ngobrol sama psikolog
            versi ringan tapi tetap meaningful."
          </p>
      ...
      <section className="bg-purple-300 py-8 px-6 relative overflow-hidden">
        {/* Background Wave (opsional, dengan opacity rendah) */}

        {/* Konten Footer */}
        <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-md p-6 grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
          {/* Logo dan Deskripsi */}
          ...
          {/* Eksplorasi Diri */}
          <div className="flex justify-between space-x-40 ml-30">
            <div>
